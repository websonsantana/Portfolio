...
--
-- Host: localhost:3306
-- Generation Time: May 30, 2024 at 01:40 PM
...
CREATE TABLE `clients` (
  ...
  `zip` varchar(56) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `user_client_preferences` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(56) COLLATE utf8_unicode_ci NOT NULL,
  `table_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `visible_columns` json DEFAULT NULL,
  `default_view` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
